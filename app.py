...
while True:
    try:
        ...
        time.sleep(1)
    try:
        i_element_xpath = '//i[contains(text(), "In order to show you the most relevant results, we have omitted some entries very similar to the 160 already displayed.")]'
        if driver.find_element(By.XPATH, i_element_xpath):
            print("Exiting")
            break
    except:
        continue
